...
public class ConnectionFactory {
    ...
    private static final String userDefault   = "pupil";
    private static final String pwdDefault    = "pupil";
    private static final String driverDefault = "oracle.jdbc.OracleDriver";
    private static final String urlDefault    = "jdbc:mysql://localhost:3306/a00";
    private static final String hostDefault   = "localhost";
    private static final String tableDefault  = "Person";
